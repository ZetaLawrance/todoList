            ...
            <div class="card">
                <div class="card-body p-4">
                    <form action="{{ route('todos.store') }}" method="POST">
                        @csrf
                        <div class="mb-3">
                            <label for="title" class="form-label fw-medium">Judul Tugas <span
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label for="priority" class="form-label fw-medium">Prioritas <span
                                        class="text-danger">*</span></label>
                                <select class="form-select @error('priority') is-invalid @enderror" id="priority"
                                    ...
                                    <option value="sedang" {{ old('priority') == 'sedang' ? 'selected' : '' }} selected>Sedang
                                    </option>
